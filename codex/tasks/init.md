...
4. **Step 4: Draft AGENTS.md Guidance**
- **GOAL:** Produce {root}/AGENTS.md that aligns with `instruction-tmpl.yaml` and reflects current architecture data.
- **STEPS:**
...
- **CHECKLIST:**
  ...
  - [ ] AGENTS.md saved at {root}/AGENTS.md.
...
- **STEPS:**
  ...
  - Review AGENTS.md for completeness, citation compliance, and navigability.
...
- **CHECKLIST:**
  ...
  - [ ] AGENTS.md content and index confirmed.
