...
**[CONTEXT]**
Need to implement a user authentication module based on tasks/develop-plan.md, decisions: follow priority hierarchy and template rules while maintaining proper execution order and verification.

**[DECISION]**
1. decisions: Read CLAUDE.md first to understand core constraints (Rule 1)
...
4. decisions: Read tasks/develop-plan.md completely (Rule 2)
5. decisions: Create implementation-plan.md using correct hierarchy: `# [Implementation-Plan]` with `## [Quality-Gate]` as H2 (Rules 4-5)
6. decisions: Execute steps sequentially without skipping (Rule 3)
7. decisions: Verify each step: run tests, check linter (Rule 7)
8. decisions: Complete Quality-Gate checklist before declaring done (Rule 8)
...
5. decisions: Use claude-context to search existing component implementations (Rules 11-12)
...
**[BAD-DECISION]**
1. decisions: [VIOLATION] Skip reading CLAUDE.md (violates Rule 1)
