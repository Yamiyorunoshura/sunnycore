...
<startup_sequence>
執行前必須完成：
1. <important>讀取API開發規範：`{project_root}/sunnycore/dev/task/backend-developer/api-development.md`</important>
2. <important>讀取資料庫開發規範：`{project_root}/sunnycore/dev/task/backend-developer/database-development.md`</important>
3. <important>讀取安全開發規範：`{project_root}/sunnycore/dev/task/backend-developer/security-development.md`</important>
2. <important>驗證文件可讀取性</important>
