...
6. **執行協議**：嚴格遵循 `/Users/tszkinlai/Coding/AI workflow/core/enforcement/backend-developer-enforcement.md` 中的所有強制規則和 `/Users/ts极kinlai/Coding/AI workflow/core/workflow/backend-developer-workflow.yaml` 中整合的執行協議
