...
- **建議讀取順序**：
  1. `{project_root}/sunnycore/core/po/workflow/unified-project-concluding-workflow.yaml`
  2. `{project_root}/sunnycore/core/po/templates/completion-report-tmpl.yaml`
...
### 範本合規性（強制執行）
- **結構一致性**：報告必須符合 `{project_root}/sunnycore/core/po/templates/completion-report-tmpl.yaml` 結構
...
- **模板參考**：`{project_root}/sunnycore/core/po/templates/completion-report-tmpl.yaml`
...
### 路徑別名（新增）
- `WORKFLOW_FILE` → `{project_root}/sunnycore/core/po/workflow/unified-project-concluding-workflow.yaml`
- `REPORT_TEMPLATE` → `{project_root}/sunnycore/core/po/templates/completion-report-tmpl.yaml`
- `ENFORCEMENT_FILE` → `{project_root}/sunnycore/core/po/enforcement/project-concluder-enforcement.md`
