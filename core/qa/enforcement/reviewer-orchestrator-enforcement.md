...
本文件與以下配置文件的關係：
- **工作流程**：被 `{project_root}/sunnycore/core/qa/workflow/reviewer-orchestrator-workflow.md` 引用
- **統一規範**：引用 `{project_root}/sunnycore/core/qa/enforcement/task-reviewer-enforcement.md`
- **統一工作流程**：引用 `{project_root}/sunnycore/core/qa/workflow/unified-review-workflow.md`
</configuration_references>
