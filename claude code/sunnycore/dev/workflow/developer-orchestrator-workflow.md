...
- **Available Developer Agents**:
  ...
  - **Backend Domain Experts**:
    - `dev_backend-developer_database`: Database design, optimization, migration
    - `dev_backend-developer_api`: RESTful API, GraphQL, microservices
    - `dev_backend-developer_security`: Authentication, authorization, security protection
    - `dev_backend-developer_performance`: Performance optimization, load testing
    - `dev_backend-developer_testing`: Testing strategy, automated testing
    - `dev_backend-developer_infrastructure`: Deployment, monitoring, DevOps
  - **Frontend Domain Experts**:
    - `dev_frontend-developer_ui-ux`: User interface, user experience
    - `dev_frontend-developer_framework`: React, Vue, Angular
    - `dev_frontend-developer_performance`: Frontend optimization, bundle optimization
    - `dev_frontend-developer_accessibility`: Accessibility design
    - `dev_frontend-developer_testing`: Frontend testing, E2E testing
  - **Fullstack Domain Experts**:
    - `dev_fullstack-developer_architecture`: System architecture, technology selection
    - `dev_fullstack-developer_integration`: System integration, third-party services
    - `dev_fullstack-developer_performance`: Fullstack performance optimization
    - `dev_fullstack-developer_devops`: CI/CD, containerization, cloud deployment
  - **Refactoring Domain Experts**:
    - `dev_refactor-developer_code-quality`: Code refactoring, architecture improvement
    - `dev_refactor-developer_performance`: Performance refactoring, optimization refactoring
  <!-- available_developers>
- **Selection Criteria**:
  <selection_criteria -->
