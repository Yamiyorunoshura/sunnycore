...
## [Constraints]
  ...
  3. Must complete all steps without stopping; do not pause between sub-phases undeer [Steps] unless [blocking conditions] occur or the prompt clearly stated that user's confirmations is needed.
