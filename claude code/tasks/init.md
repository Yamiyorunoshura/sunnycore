...
### 4. Generate Project Guidance (CLAUDE.md)
...
**Focus:** CLAUDE.md is the single source of truth for developers. Make it comprehensive and well-organized with proper citations.
...
- [ ] CLAUDE.md exists with complete information
